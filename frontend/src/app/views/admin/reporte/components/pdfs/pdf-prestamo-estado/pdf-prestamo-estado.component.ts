...
@Component({
  ...
  templateUrl: "./pdf-prestamo-estado.component.html",
  styles: [],
})
export class PdfPrestamoEstadoComponent implements OnInit {
      ...
      content: [
        ...
        "\n",
        {
          columns: [
            {
              width: 250,
              text: `Prestamos ${this.prestamos[0].estado}S Desde ${this.datePipe.transform(
                this.from,
                "mediumDate"
              )}`,
            },
