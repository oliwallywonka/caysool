(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["prestamo-prestamo-module"], {
              ...
              content: [{
                ...
                table: {
                  ...
                  body: [[{
                    ...
                    text: "Bol. ".concat(this.pago.tipoPago === 'INTERES' ? "0.00" : this.pago.costoPago),
                    alignment: "right"
                  }], [{
                    text: "",
                    alignment: "center"
                    ...
                    text: "Bol. ".concat(this.pago.tipoPago === "INTERES" ? this.pago.costoPago : this.prestamo.costoInteres),
                    alignment: "right"
                  }], [{
                    text: "",
                    alignment: "center"
    ...
    function C1X(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_core_services_impresion_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var src_app_core_services_pago_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/core/services/pago.service */
      "AntR");
      /* harmony import */
      ...
      var CardPrestamoDetalleComponent = /*#__PURE__*/function () {
        function CardPrestamoDetalleComponent(amortizacionService, impresionService, pagoService, prestamoService, modalService, route, location, datePipe) {
    ...
    function MAJT(module, __webpack_exports__, __webpack_require__) {
      ...
      var CardPrestamosComponent = /*#__PURE__*/function () {
        function CardPrestamosComponent(prestamoService, modalService, alertService, router, fb) {
        ...
        _createClass(PdfDocumentoComponent, [{
          ...
          value: function exportToPdf() {
            var contrato = {
              ...
              "Fecha de la compra y venta: La Paz \u2013 El Alto ".concat(this.datePipe.transform(this.prestamo.fechaInicio, 'mediumDate'), " \n\n\n\n\n\n\n\n\n\n"), //numero del CI vendedor y comprador
              {
                alignment: "center",
                columns: [{
