...
let NewPrestamoModalComponent = class NewPrestamoModalComponent {
    ...
    calculateCostoTotal(event = '') {
        ...
        this.diasPrestamo = 0;
        this.costoTotal = 0;
        const diaInicio = moment__WEBPACK_IMPORTED_MODULE_8__(this.prestamoForm.value.fechaInicio);
        const diaFinal = moment__WEBPACK_IMPORTED_MODULE_8__(this.prestamoForm.value.fechaFinal);
        const dias = moment__WEBPACK_IMPORTED_MODULE_8__["duration"](diaFinal.diff(diaInicio)).asDays() + 1;
