...
let CardPrestamoDetalleComponent = class CardPrestamoDetalleComponent {
    ...
    calculateDiasRestantes() {
        const diaInicio = moment__WEBPACK_IMPORTED_MODULE_11__(this.prestamo.fechaInicio);
        const diaFinal = moment__WEBPACK_IMPORTED_MODULE_11__(this.prestamo.fechaFinal);
...
let ModalEditPrestamoComponent = class ModalEditPrestamoComponent {
    ...
    calculateCostoTotal(event = '') {
        this.diasPrestamo = 0;
        this.costoTotal = 0;
        const diaInicio = moment__WEBPACK_IMPORTED_MODULE_9__(this.prestamoForm.value.fechaIncio).startOf('day');
        const diaFinal = moment__WEBPACK_IMPORTED_MODULE_9__(this.prestamoForm.value.fechaFinal).endOf('day');
        const dias = moment__WEBPACK_IMPORTED_MODULE_9__["duration"](diaFinal.diff(diaInicio)).asDays();
