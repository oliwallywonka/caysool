      ...
      var NewPrestamoModalComponent = /*#__PURE__*/function () {
        ...
        _createClass(NewPrestamoModalComponent, [{
          ...
          value: function calculateCostoTotal() {
            ...
            this.diasPrestamo = 0;
            this.costoTotal = 0;
            var diaInicio = moment__WEBPACK_IMPORTED_MODULE_8__(this.prestamoForm.value.fechaInicio);
            var diaFinal = moment__WEBPACK_IMPORTED_MODULE_8__(this.prestamoForm.value.fechaFinal);
            var dias = moment__WEBPACK_IMPORTED_MODULE_8__["duration"](diaFinal.diff(diaInicio)).asDays() + 1;
